                  ...
                  child: Row(
                    ...
                    children: [
                      TextButton.icon(
                        ...
                        icon: Icon(FeatherIcons.arrowLeft,color: Colors.black,size: 17,),
                        label: Text(
                      ...
                      TextButton.icon(
                        ...
                        icon: SvgPicture.asset('assets/icons/Icon-feather-check.svg',width: 10, height: 12 ,),
                        label: Text(
                          AppLocalizations.of(context)!.save,
                          style: GoogleFonts.roboto(color: Color(0xff018f9c), fontSize: 16, fontWeight: FontWeight.w500),
                        ),
                      ),
                    ],
                  ),
                              ...
                              child: Container(
                                ...
                                child: filePath == null
                                    ? editProfileStore.photoUrl == null
                                        ? CircleAvatar(
                                            radius: 57,
child: SvgPicture.asset('assets/icons_profile/user.svg', color: Colors.white,),
                      ...
                      TextFormField(
                          ...
                          decoration:
                              GlobalConstants.of(context).loginInputTheme('').copyWith(contentPadding: EdgeInsets.all(16))),
                      SizedBox(
                        height: 18,
                      ),
                      Text(
                      ...
                      InternationalPhoneNumberInput(
                              ...
                              textStyle:  editProfileStore.validCellPhone ?GoogleFonts.roboto(
  ...
  BorderSide(width: 1, color: Color(0xff8E1816)),
                      ...
                      SfSliderTheme(
                        data: SfSliderThemeData(
                            activeTrackColor: Color(0xff03DAC5).withOpacity(0.3),
                            ...
                            activeTickColor: Color(0xff03DAC5),
...
disabledActiveMinorTickColor: Color(0xff03DAC5),
                        disabledActiveTickColor: Color(0xff03DAC5),
                        disabledActiveTrackColor: Color(0xff03DAC5),
                        disabledInactiveDividerColor: Color(0xff03DAC5),
                        disabledInactiveMinorTickColor: Color(0xff03DAC5),
                        disabledInactiveTickColor: Color(0xff03DAC5),
                        disabledInactiveTrackColor: Color(0xff03DAC5),
                        inactiveDividerStrokeColor: Color(0xff03DAC5),
                        inactiveMinorTickColor: Color(0xff03DAC5),
                        ...
                        child: SfSlider(
                          ...
                          inactiveColor: Color(0xff03DAC5).withOpacity(0.5),
