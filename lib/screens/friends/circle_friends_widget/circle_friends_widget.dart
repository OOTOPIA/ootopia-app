...
class _CircleOfFriendWidgetState extends State<CircleOfFriendWidget> {
  ...
  CircleFriendsWidgetStore circleFriendsWidgetStore =
      CircleFriendsWidgetStore();
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isUserLogged) {
      return Consumer<FriendsStore>(builder: (context, counter, _) {
        return body();
      });
    } else {
            ...
            child: Row(
              ...
              children: [
                if (!friendsStore.isLoading &&
                    !circleFriendsWidgetStore.isLoading) ...[
                  Padding(
  ...
  void _goToProfile(userId) async {
    if (widget.displayContacts != null && widget.displayContacts!) {
      Navigator.pushNamed(
        context,
