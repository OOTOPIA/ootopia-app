...
class _RegisterPhoneNumberScreenState extends State<RegisterPhoneNumberScreen> {
        ...
        leading: Padding(
          ...
          child: InkWell(
              onTap: () {
                ...
                registerController.cleanBirthDateFields();
              },
              child: Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (!registerController.validationBirthDate()) {
          setState(() {
            registerController.cleanBirthDateFields();
          });
          return true;
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                if (registerController
                                    ...
                                    registerController.validationBirthDate())
                                  Navigator.of(context).pushNamed(
                                    PageRoute.Page
                                        .registerDailyLearningGoalScreen.route,
                                  );
                              }),
                        )
                      ],
